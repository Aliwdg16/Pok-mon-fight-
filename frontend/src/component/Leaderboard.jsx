  ...
  return (
    <>
      ...
      <div className=" flex justify-center min-h-[40rem]">
        ...
        <div className=" bg-[url('./typeIcons/leaderboard.png')] w-[100%]  h-auto bg-no-repeat mt-28  relative"></div>
        ...
        <div className=" bg-[url('./typeIcons/leaderboard2.png')] w-[100%] bg-right  h-auto bg-no-repeat mt-28  "></div>
      </div>
    </>
  );
};
